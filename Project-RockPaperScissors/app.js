...
const choiceYour = document.querySelector('.your-choice');
const choiceComputer = document.querySelector('.computer-choice');

let playerScore = 0;
let computerScore = 0;

// Start the game when user clicks at an image
...
/* Logical things of the game, function and conditionals */
...
function getComputerSelection() {
  ...
  function game(playerSelect) {
    ...
    choiceYour.appendChild(createParagWithText(playerSelection));
    choiceComputer.appendChild(createParagWithText(computerSelection));
